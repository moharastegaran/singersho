                    ...
                    <?php else : ?>
                        <li class="dropdown-item <?php echo (strpos($current_url, 'profile.php') !== false) ? 'active' : '' ?>">
                            <a href="profile.php"><img src="assets/img/icons/sign-in-alt.svg">
                                پروفایل</a></li>
                        <li class="dropdown-item item-logout"><a href="logout.php"><img
                                        src="assets/img/icons/logout-danger.svg"> خروج</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </li>
        ...
        <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item">
                <a href="checkout.php" class="btn__cart">
                    ...
                    <span class="cart__counter <?php echo (isset($cart_counter) && $cart_counter > 0) ? '' : 'd-none'?>">
                        <?php echo $cart_counter; ?></span>
                </a>
            </li>
        </ul>
    </nav>
