            ...
            function place(currentInput, maxLengthIndicator) {
                ...
                switch (options.placement) {
                    ...
                    case 'left':
                        ...
                        break;
                    case 'right':
                        maxLengthIndicator.css({ top: pos.top + pos.height / 2 - actualHeight / 2, left: pos.left + pos.width - 15 });
                        break;
                    case 'bottom-right':
                        maxLengthIndicator.css({ top: pos.top + pos.height, left: pos.left + pos.width  - 15 });
                        break;
                    case 'top-right':
                        maxLengthIndicator.css({ top: pos.top - actualHeight, left: pos.left + inputOuter - 15 });
                        break;
                    case 'top-left':
