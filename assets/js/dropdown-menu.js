...
jQuery(document).ready(function($){
    ...
    var albumMenu = [
        ...
        {
            text: 'افزودن به پخش بعدی',
        },
        {
            text: 'ذخیره در کتابخانه',
        },
        {
            text: 'پسندیدن',
        },
        {
            text: 'اشتراک گذاری آلبوم',
        },
    ];
    ...
    var playlistTrackMenu = [{
        text: '<i class="icon-heart"></i> پسندیدن',
    },{
        text: '<i class="icon-share-2"></i> اشتراک گذاری',
    },{
        class: 'remove-track-item-playlist',
        text: '<i class="icon-x"></i> حذف کردن',
    },{
        text: '<i class="icon-list2"></i> افزودن به لیست پخش',
    }];
