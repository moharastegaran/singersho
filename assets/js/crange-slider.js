...
$('.slider').each(function(e) {
    ...
    slider.slider({
        ...
        create(event, ui) {
            ...
            $(slider.data('value-0')).html(formatPrice(slider.slider('values', 0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, '')));
            $(slider.data('value-1')).html(formatPrice(slider.slider('values', 1).toString().replace(/\B(?=(\d{3})+(?!\d))/g, '')));
        ...
        slide(event, ui) {
            ...
            $(slider.data('value-0')).html(formatPrice(ui.values[0].toString().replace(/\B(?=(\d{3})+(?!\d))/g, '')));
            $(slider.data('value-1')).html(formatPrice(ui.values[1].toString().replace(/\B(?=(\d{3})+(?!\d))/g, '')));
            $(slider.data('range')).html((slider.slider('values', 1) - slider.slider('values', 0)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ''));
...
function resetSlider(){
    const slider = $('.slider');
    slider.slider('values',0,mmin);
    slider.slider('values',1,mmax);
